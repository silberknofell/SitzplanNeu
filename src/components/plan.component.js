...
var PlanComponent = (function () {
    ...
    PlanComponent.prototype.onPlanChange = function (plan) {
        if (plan) {
    ...
    PlanComponent.prototype.saveClick = function (plan) {
        this.planService.updatePlan(plan);
    };
    PlanComponent.prototype.deleteClick = function () {
        var _this = this;
        this.planService.deletePlan(this._plan.id)
            .subscribe(function () {
            alert("Plan gelöscht");
            _this.router.navigate(['/plaene', _this.gruppe.id]);
        });
    };
    __decorate([
        core_1.Input(), 
    ...
    PlanComponent = __decorate([
        core_1.Component({
            ...
            inputs: [],
            directives: [cell_component_1.CellComponent, lager_component_1.LagerComponent, gruppen_erstellen_component_1.GruppenErstellenComponent],
            providers: [],
            styles: [
