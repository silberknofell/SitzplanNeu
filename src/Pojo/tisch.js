System.register(["./cell", "./sus", "angular2/core", "./element"], function(exports_1, context_1) {
    "use strict";
    ...
    var cell_1, sus_1, core_1, element_1;
    var Tisch;
    return {
        setters:[
            function (cell_1_1) {
